...
const Footer = () => {
  return (
    <div>
      <footer class="flex flex-col items-center bg-gray-900 text-center text-surface text-white">
        ...
        <div class="w-full bg-black/5  text-center">Last Updated May 31 2026</div>
